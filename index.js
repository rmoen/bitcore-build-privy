...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-privy/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-privy -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-privy -o bitcore-lib-privy.js';
    }
